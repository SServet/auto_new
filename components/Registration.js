    ...
    <div className="bg-theme-gray-3 overflow-hidden lg:px-6 md:!px-0">
      <div className="relative w-10/12 lg:w-full max-w-ag-container md:!w-full mx-auto flex lg:flex-col bg-white p-6">
        <div className="w-1/2 lg:w-full relative before:lg:w-full mr-3 flex flex-col text-theme-gray-4 text-15 md:text-xs lg:flex-col">
          <div className="p-6 rounded-10 bg-theme-gray-4">
            <div className="flex items-center justify-between text-3xl md:text-xl font-bold text-white mb-4">
              <button onClick={() => setIsStepActive(1)}
                className={`h-14 w-14 md:w-10 md:h-10 flex items-center justify-center rounded-full ${isStepActive == 1 ? "bg-theme-yellow-2" : "bg-theme-gray-8"
                  }`}
              >
                1
              </button>
              ...
              <button
                ...
                className={`h-14 w-14 md:w-10 md:h-10 flex items-center justify-center rounded-full ${isStepActive == 2 ? "bg-theme-yellow-2" : "bg-theme-gray-8"
                  }`}
              >
                2
              </button>
              ...
              <button
                ...
                className={`h-14 w-14 md:w-10 md:h-10 flex items-center justify-center rounded-full ${isStepActive == 3 ? "bg-theme-yellow-2" : "bg-theme-gray-8"
                  }`}
              >
                3
              </button>
              ...
              <div className="">
                  ...
                  <div className="flex mb-4">
                    ...
                    >
                      <div className="bg-white w-6 h-6 p-1 flex justify-center items-center mr-2 rounded">
                        ...
                        />
                        <svg
                          className={`${gender === "male" ? "block" : "hidden"
                    ...
                    >
                      <div className="bg-white w-6 h-6 p-1 flex justify-center items-center mr-2 rounded">
                        ...
                        />
                        <svg
                          className={`${gender === "female" ? "block" : "hidden"
                            } w-4 h-4 text-purple pointer-events-none`}
                          viewBox="0 0 172 172"
                        >
                          <g
                ...
                <div className="">
                    ...
                    <div className="w-1/2 md:!w-full ml-2 h-14 flex text-11 flex-col justify-between pt-2">
                      ...
                      >
                        <div className="bg-white w-4 h-4 p-1 flex justify-center items-center mr-2 rounded">
                          ...
                          />
                          <svg
                            className={`${newsLaterChecked ? "block" : "hidden"
                              } w-4 h-4 text-purple pointer-events-none`}
                            viewBox="0 0 172 172"
                          >
                            <g
                      ...
                      >
                        <div className="bg-white w-4 h-4 p-1 flex justify-center items-center mr-2 rounded">
                          ...
                          />
                          <svg
                            className={`${privacyChecked ? "block" : "hidden"
                              } w-4 h-4 text-purple pointer-events-none`}
                            viewBox="0 0 172 172"
                          >
                            <g
                  ...
                  <div className="flex md:flex-col items-center mt-6">
                    ...
                    />
                    <button onClick={() => setIsStepActive(2)} className="w-1/2 sm:w-full sm:mb-4 sm:mr-0 ml-2 inline-block px-10 py-3 sm:px-4 sm:text-sm rounded-10 bg-theme-yellow-2 text-white text-base font-bold ease-linear duration-300 hover:bg-theme-yellow-3">
                      Neu registrieren
                    </button>
                  </div>
                </div>
            ...
            {isStepActive === 3 && <div className="flex flex-col items-center text-base py-20 md:py-10">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="100"
                height="84.305"
              ...
              <p className="mb-6 md:my-4 text-center">Sie werden in Kürze zur Startseite weitergeleitet.</p>
        ...
        <div className="relative w-1/2 lg:w-auto lg:ml-0 lg:mt-4 ml-3">
          <img className="w-full h-full rounded-10" src={`/images/${isStepActive === 1 ? 'reg-car' : isStepActive === 2 ? 'dealer-register-close' : isStepActive === 3 ? 'register-success' : null}.png`} />
        </div>
      </div>
    </div>
  );
